...
class LoginForm(FlaskForm):
    ...
    password = PasswordField(
        ...
        render_kw={'placeholder': 'Example: Vortex123'})
...
# Define a base form
# Let children inherit the manager form
# ========================================
...
class managerRegistrationForm(UserForm):
...
class EmployeeRegistrationForm(UserForm):
    ...
    school = StringField(
        ...
        render_kw={'placeholder': 'Employee\'s formal school'})
